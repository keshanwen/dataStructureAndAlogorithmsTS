...
export class BinaryHeap<E> extends AbstractHeap<E> implements BinaryTreeInfo {
  ...
  constructor(elements?: E[] | Comparator<E>, comparator?: Comparator<E>) {
    if (arguments.length === 1 && !Array.isArray(elements))
      comparator = elements;
    super(comparator);
    ...
    if (
      ...
      this._size = (elements as E[]).length;
  ...
  private siftDown(index: number): void {
    ...
    while (index < half) {
      ...
      if (
        ...
        this.compare(this.elements[rightIndex], child) > 0
      ) {
